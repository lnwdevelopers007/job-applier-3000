<script lang="ts">
	import { FileText, Download, BriefcaseBusiness, Globe, MapPin } from 'lucide-svelte';
	...
	const skills = $derived(() => {
		...
		return ['JavaScript', 'TypeScript', 'React', 'Node.js', 'Python', 'PostgreSQL', 'MongoDB', 'Docker', 'AWS', 'Git'];
	});
...
<SideDrawer 
	...
	width="820px"
>
	<div class="max-w-3xl mx-auto bg-white border border-gray-200 rounded-lg p-8 shadow-xs">
		<!-- Profile Header -->
