...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50">
  <div class="w-full max-w-lg p-10 bg-white rounded-sm border border-gray-200 shadow-sm">
    ...
    <div class="flex items-center space-x-1 mb-6">
      <ChevronLeft class="w-5 h-5 text-gray-600 cursor-pointer" on:click={() => window.history.back()} />
      <h2 class="text-lg font-semibold text-black">Job Applier </h2>
      <h2 class="text-lg font-semibold text-green-700">3000</h2>
    </div>
    <h1 class="text-2xl font-semibold text-gray-900 mb-5">Login to your account</h1>
      ...
      <div class="flex items-center justify-between">
        <label class="flex items-center cursor-pointer">
          <input
            ...
            class="w-4 h-4 text-green-600 border-gray-300 rounded focus:ring-0 focus:ring-offset-0"
          />
